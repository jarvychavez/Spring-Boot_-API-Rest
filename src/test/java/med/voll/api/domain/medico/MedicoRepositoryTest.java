...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deberia devolver null cuando el medico buscado existe pero no se encuentra disponible en esa fecha")
    ...
    @Test
    @DisplayName("Deberia devolver medico cuando medico buscado esta disponible en esa fecha")
