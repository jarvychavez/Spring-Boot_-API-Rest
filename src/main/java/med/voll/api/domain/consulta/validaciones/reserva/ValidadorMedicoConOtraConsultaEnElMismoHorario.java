...
public class ValidadorMedicoConOtraConsultaEnElMismoHorario implements ValidadorDeConsultas{
    ...
    public void  validar(DatosReservaConsulta datos){
        var medicoTiempoOtraConsultaEnElMismoHorario = repository.existsByMedicoIdAndFecha(datos.idMedico(), datos.fecha());
        if (medicoTiempoOtraConsultaEnElMismoHorario){
